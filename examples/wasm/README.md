...
1. **SDL3**: The SDL3 library is compiled to `sdl.wasm` via Emscripten.
...
> [!Tip]
> All of the compiled files are placed into `/build/` directory, ready to be compressed and distributed.
