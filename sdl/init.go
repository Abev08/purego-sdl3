...
func init() {
	...
	sdlGetPerformanceCounterPtr := shared.Get(lib, "SDL_GetPerformanceCounter")
	sdlGetPerformanceCounter = func() uint64 {
		ret, _, _ := purego.SyscallN(sdlGetPerformanceCounterPtr)
		return uint64(ret)
	}
	sdlGetPerformanceFrequencyPtr := shared.Get(lib, "SDL_GetPerformanceFrequency")
	sdlGetPerformanceFrequency = func() uint64 {
		ret, _, _ := purego.SyscallN(sdlGetPerformanceFrequencyPtr)
		return uint64(ret)
	}
	...
	sdlPollEventPtr := shared.Get(lib, "SDL_PollEvent")
	sdlPollEvent = func(event *Event) bool {
		ret, _, _ := purego.SyscallN(sdlPollEventPtr, uintptr(unsafe.Pointer(event)))
		return byte(ret) != 0
	}
	...
	sdlRenderClearPtr := shared.Get(lib, "SDL_RenderClear")
	sdlRenderClear = func(renderer *Renderer) bool {
		ret, _, _ := purego.SyscallN(sdlRenderClearPtr, uintptr(unsafe.Pointer(renderer)))
		return byte(ret) != 0
	}
	...
	sdlRenderFillRectPtr := shared.Get(lib, "SDL_RenderFillRect")
	sdlRenderFillRect = func(renderer *Renderer, rect *FRect) bool {
		ret, _, _ := purego.SyscallN(sdlRenderFillRectPtr, uintptr(unsafe.Pointer(renderer)), uintptr(unsafe.Pointer(rect)))
		return byte(ret) != 0
	}
	sdlRenderFillRectsPtr := shared.Get(lib, "SDL_RenderFillRects")
	sdlRenderFillRects = func(renderer *Renderer, rects []FRect) bool {
		...
		ret, _, _ := purego.SyscallN(sdlRenderFillRectsPtr, uintptr(unsafe.Pointer(renderer)), uintptr(unsafe.Pointer(rectsPtr)), uintptr(count))
		return byte(ret) != 0
	}
	...
	sdlRenderLinesPtr := shared.Get(lib, "SDL_RenderLines")
	sdlRenderLines = func(renderer *Renderer, points []FPoint) bool {
		...
		ret, _, _ := purego.SyscallN(sdlRenderLinesPtr, uintptr(unsafe.Pointer(renderer)), uintptr(unsafe.Pointer(pointsPtr)), uintptr(count))
		return byte(ret) != 0
	}
	...
	sdlRenderPresentPtr := shared.Get(lib, "SDL_RenderPresent")
	sdlRenderPresent = func(renderer *Renderer) bool {
		ret, _, _ := purego.SyscallN(sdlRenderPresentPtr, uintptr(unsafe.Pointer(renderer)))
		return byte(ret) != 0
	}
	purego.RegisterLibFunc(&sdlRenderReadPixels, lib, "SDL_RenderReadPixels")
	sdlRenderRectPtr := shared.Get(lib, "SDL_RenderRect")
	sdlRenderRect = func(renderer *Renderer, rect *FRect) bool {
		ret, _, _ := purego.SyscallN(sdlRenderRectPtr, uintptr(unsafe.Pointer(renderer)), uintptr(unsafe.Pointer(rect)))
		return byte(ret) != 0
	}
	...
	sdlSetRenderDrawColorPtr := shared.Get(lib, "SDL_SetRenderDrawColor")
	sdlSetRenderDrawColor = func(renderer *Renderer, r, g, b, a uint8) bool {
		ret, _, _ := purego.SyscallN(sdlSetRenderDrawColorPtr, uintptr(unsafe.Pointer(renderer)), uintptr(r), uintptr(g), uintptr(b), uintptr(a))
		return byte(ret) != 0
	}
