...
const (
	StyleNormal        FontStyleFlags = 0x00 // No special style.
	StyleBold          FontStyleFlags = 0x01 // Bold style.
	StyleItalic        FontStyleFlags = 0x02 // Italic style.
	StyleUnderline     FontStyleFlags = 0x04 // Underlined text.
	StyleStrikethrough FontStyleFlags = 0x08 // Strikethrough text.
)
...
type HintingFlags int32

const (
	HintingInvalid       HintingFlags = iota - 1
	HintingNormal                     // Normal hinting applies standard grid-fitting.
...
// [GetFontWeight] queries a font's weight, in terms of the lightness/heaviness of the strokes.
//
// Available since SDL_ttf 3.2.2.
//
// [GetFontWeight]: https://wiki.libsdl.org/SDL3_ttf/TTF_GetFontWeight
func GetFontWeight(font *Font) int32 {
	return ttfGetFontWeight(font)
}
...
const (
	SubStringDirectionMask SubStringFlags = 0x000000FF // The mask for the flow direction for this substring.
	SubStringTextStart     SubStringFlags = 0x00000100 // This substring contains the beginning of the text.
	SubStringLineStart     SubStringFlags = 0x00000200 // This substring contains the beginning of line `line_index`.
	SubStringLineEnd       SubStringFlags = 0x00000400 // This substring contains the end of line `line_index`.
	SubStringTextEnd       SubStringFlags = 0x00000800 // This substring contains the end of the text.
)
